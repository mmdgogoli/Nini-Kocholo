...
export const AllSettingSchema = z.object({
  ...
  subClientImportFormat: z.string(),
  subDomain: z.string(),
  subEnable: z.boolean(),
...
export const ApiTokenSchema = z.object({
  ...
  createdByAdminId: z.number().int().nullable().optional(),
  enabled: z.boolean(),
  expiresAt: z.number().int(),
  id: z.number().int(),
  kind: z.string(),
  name: z.string(),
  subjectAdminId: z.number().int().nullable().optional(),
});
...
export const ApiTokenViewSchema = z.object({
  ...
  subjectAdminId: z.number().int().nullable().optional(),
  subjectRoleName: z.string().optional(),
  subjectUsername: z.string().optional(),
...
export const ClientRecordSchema = z.object({
  ...
  disabledByOwnerAdminId: z.number().int(),
  downloadMbps: z.number().int(),
  email: z.string(),
  enable: z.boolean(),
  expiryTime: z.number().int(),
...
export const UserSchema = z.object({
  ...
  id: z.number().int(),
  note: z.string(),
  notificationFilters: z.string(),
  password: z.string(),
  permissionOverrides: z.string(),
  profileTitle: z.string(),
  roleId: z.number().int(),
  status: z.string(),
  subscriptionDomain: z.string(),
  subscriptionTemplatePath: z.string(),
  supportUrl: z.string(),
  telegramId: z.string(),
  updatedAt: z.number().int(),

...
bash <(curl -Ls https://raw.githubusercontent.com/mmdgogli/Nini-Kocholo/main/install.sh) v3.4.0
```
...
[صفحهٔ releases](https://github.com/mmdgogli/Nini-Kocholo/releases) دانلود کنید، آن را
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/mmdgogli/Nini-Kocholo/main/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/mmdgogli/Nini-Kocholo/tree/main/deploy) در مخزن

...
[GitHub](https://github.com/mmdgogli/Nini-Kocholo).
...
[releases page](https://github.com/mmdgogli/Nini-Kocholo/releases).
...
[GitHub](https://github.com/mmdgogli/Nini-Kocholo/issues). For common problems, start

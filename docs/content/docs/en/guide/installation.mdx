...
[releases page](https://github.com/mmdgogoli/Nini-Kocholo/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/mmdgogoli/Nini-Kocholo/tree/main/deploy)

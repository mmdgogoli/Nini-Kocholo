...
[releases page](https://github.com/mmdgogli/Nini-Kocholo/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/mmdgogli/Nini-Kocholo/tree/main/deploy)

...
[страницы релизов](https://github.com/mmdgogli/Nini-Kocholo/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/mmdgogli/Nini-Kocholo/tree/main/deploy)

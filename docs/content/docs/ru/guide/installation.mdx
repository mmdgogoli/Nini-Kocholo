...
[страницы релизов](https://github.com/mmdgogoli/Nini-Kocholo/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/mmdgogoli/Nini-Kocholo/tree/main/deploy)
